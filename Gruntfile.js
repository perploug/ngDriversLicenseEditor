module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
        src: [
          'app/scripts/controllers/drivers.license.editor.controller.js'
        ],
        dest: '<%= dest %>/<%= basePath %>/js/drivers.license.editor.js',
        nonull: true
      }
    },
    ...
    less: {
      dist: {
        ...
        files: {
          '<%= dest %>/<%= basePath %>/css/drivers.license.editor.css': 'app/styles/drivers.license.editor.less',
        }
      }
    },
  ...
  grunt.registerTask('default', ['jshint', 'concat', 'less', 'copy:config', 'copy:views', 'copy:styleAssets']);
